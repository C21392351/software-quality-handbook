...
## Estimation Flow
    ...
    Backlog item introduced
            |
            v
    Team reviews the item together
            |
            v
    Questions, risks, and dependencies identified
            |
            v
    Each team member estimates independently
            |
            v
    Estimates revealed and discussed
            |
            v
    Consensus reached?
       /             \
     Yes             No
      |               |
      v               v
    Log estimate   Discuss differences
                       |
                       v
                 Re-estimate together
                       |
                       v
                  Log agreed estimate
