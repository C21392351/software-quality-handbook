...
**Goal:** Practical, skim-readable software quality handbook covering three topics:
1. Task Estimation in Scrum
2. Code Reviews
3. Bug Tracking & Defect Management

---

## Branching Strategy

We are following **Trunk-Based Development**:
...
|---|---|---|---|---|
| Create Project Plan (`PROJECT-PLAN.md`) | Akash | `feature/project-plan` | Mark | Sun 29 Mar |
| Set up README.md — intro, purpose, table of contents | Mark | `feature/readme-setup` | Akash | Sun 29 Mar |
| Research 5 sources — Task Estimation | Akash | `feature/task-estimation-research` | Dean | Mon 30 Mar |
| Research 5 sources — Code Reviews | Mark | `feature/code-reviews-research` | Dean | Mon 30 Mar |
